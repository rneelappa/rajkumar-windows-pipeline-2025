#!/usr/bin/env python3
"""
Comprehensive Master Data Migration
Extract all master data types from Tally one by one to avoid crashes
"""
...
class ComprehensiveMasterMigration:
    def __init__(self):
    ...
    def run_comprehensive_migration(self):
        """Run comprehensive master data migration."""
        logger.info("🚀 Starting comprehensive master data migration...")
        ...
        logger.info("=" * 60)
        logger.info("📊 COMPREHENSIVE MASTER DATA MIGRATION SUMMARY")
        logger.info("=" * 60)
        ...
        if success_count == len(master_types):
            logger.info("🎉 All master data types migrated successfully!")
        else:
...
def main():
    migration = ComprehensiveMasterMigration()
    migration.run_comprehensive_migration()
